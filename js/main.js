...
function renderCart() {
  ...
  const itemsHtml = cart.map(item => `
    <div class="cart-item">
      <img src="https://ae-pic-a1.aliexpress-media.com/kf/S6ed4cbab10b54397bd45040e94440d93u.jpg_480x480q75.jpg_.avif" alt="${item.name}" />
  ...
  container.innerHTML = `
    <div class="cart-layout">
      ...
      <div class="cart-summary" id="cartSummary">
        ...
        <button class="checkout-btn" onclick="showToast('🔒 Secure checkout coming soon with Shopify')">Checkout Securely →</button>
      ...
      return `
        <div class="bundle-card ${b.featured ? 'featured' : ''}">
          ...
          <div class="bundle-body">
            ...
            <button class="btn btn-accent bundle-cta" onclick="addToCart('${b.id}','${b.name.replace(/'/g,"\\'")} Bundle',${b.price}); showToast('✓ ${b.name} added to cart')">
              Add to Cart — $${b.price.toFixed(2)}
            </button>
          </div>
        </div>
      `;
